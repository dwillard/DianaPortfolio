$(document).ready(function() {
    ...
    var allArtworks = [
        ...
        new Artwork("artwork3", "starrysea", "Starry Sea", "Acrylic on canvas, 2013"),
        new Artwork("artwork4", "warmth", "Warmth", "Acrylic on canvas, 2013"),
        new Artwork("artwork5", "allthecowgirls", "All the Cowgirls", "Acrylic on canvas, 2013"),
        new Artwork("artwork6", "relic", "Relic", "Acrylic on canvas, 2013"),
        new Artwork("artwork7", "intothewoods", "Into the Woods", "Acrylic on canvas, 2013"),
        new Artwork("artwork8", "avenueofthesaints", "Avenue of the Saints", "Acrylic on canvas, 2013"),
        new Artwork("artwork9", "peninsula", "Peninsula", "Acrylic on canvas, 2013"),
        new Artwork("artwork10", "alice", "Alice", "Acrylic on canvas, 2013"),
        new Artwork("artwork11", "kara", "Kara", "Acrylic on canvas, 2013"),
        new Artwork("artwork12", "kiana", "Kiana", "Acrylic on canvas, 2013"),
        new Artwork("artwork13", "nora", "Nora", "Acrylic on canvas, 2013"),
        new Artwork("artwork14", "leaves", "Leaves", "Acrylic on canvas, 2013"),
        new Artwork("artwork15", "branches", "Branches", "Acrylic on canvas, 2013"),
        new Artwork("artwork16", "feather", "Feather", "Acrylic on canvas, 2013"),
        new Artwork("artwork17", "nest", "Nest", "Acrylic on canvas, 2013"),
        new Artwork("artwork18", "petals", "Petals", "Acrylic on canvas, 2013"),
        new Artwork("artwork14", "grasses", "Grasses", "Acrylic on canvas, 2013"),
    ];
